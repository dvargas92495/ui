...
const TermsOfUse = ({ name, domain }: { name: string; domain: string }) => (
  <div>
    ...
    <H6>No Support or Maintenance</H6>
    <Body>
    ...
    <Body>
      ...
      responsible for any Third-Party Links. Company provides access to these
      Third-Party Links only as a convenience to you, and does not review,
    ...
    <Body>
      ...
      Site at any time for any reason at our sole discretion, including for any
      use of the Site in violation of these Terms. Upon termination of your
    ...
    <H6> Notice Requirement and Informal Dispute Resolution.</H6>
    <Body>
      ...
      should be sent to: Earth. After the Notice is received, you and the
      Company may attempt to resolve the claim or dispute informally. If you and
      the Company do not resolve the claim or dispute within thirty (30) days
    ...
    <Body>
      ...
      greater of the award or $2,500.00. Each party shall bear its own costs and
      disbursements arising out of the arbitration and shall pay an equal share
      of the fees and costs of the ADR Provider.
    </Body>
    <H6> Additional Rules for Non-Appearance Based Arbitration.</H6>
    <Body>
    ...
    <H6> Waiver of Class or Consolidated Actions.</H6>
    <Body>
    ...
    <H6> Claims Not Subject to Arbitration.</H6>
    <Body>
