...
const PrivacyPolicy = ({ name, domain }: { name: string; domain: string }) => (
  <>
    ...
    <Body>
      ...
      privacy policy requirements enforced by Vargas Arts, LLC itself.
    </Body>
    <Body>
      At Vargas Arts, LLC, one of our main priorities is the privacy of our
      visitors. This Privacy Policy document contains types of information that
      is collected and recorded by Vargas Arts and how we use it.
    </Body>
    <Body>
    ...
    <Body>
      ...
      and/or collect in Vargas Arts applications. This policy is not applicable
